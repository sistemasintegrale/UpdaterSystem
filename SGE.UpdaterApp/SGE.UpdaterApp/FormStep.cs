    ...
    public partial class FormStep : Form
    {
        ...
        void tabSelect()
        {
            ...
            Constantes.conneciones.ForEach(x =>
            {
                ...
                { var obj9 = new Empresas(); obj9.Id = Constantes.ConnTelasLima; obj9.Name = "TELAS LIMA"; list.Add(obj9); }
                if (x == Constantes.ConnUlike)
                { var obj10 = new Empresas(); obj10.Id = Constantes.ConnUlike; obj10.Name = "ULIKE"; list.Add(obj10); }
                if (x == Constantes.ConnMultiEmpresa)
                { var obj11 = new Empresas(); obj11.Id = Constantes.ConnMultiEmpresa; obj11.Name = "MULTI EMPRESA"; list.Add(obj11); }
                    if (x == Constantes.ConnJabsa)
                ...
                if (x == Constantes.ConnIglesiaSJ)
                { var obj15 = new Empresas(); obj15.Id = Constantes.ConnIglesiaSJ; obj15.Name = "IGLESIA SJL"; list.Add(obj15); }
            });
